        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
            <div class="modal-content shadow-lg">
                ...
                <div class="modal-body p-0 m-0">
                    ...
                    <div class="d-flex align-items-center justify-content-between" v-for="like in likes" :key="like.id">
                            ...
                            <router-link class="lead text-decoration-none text-dark"
                                ...
                                <button type="button" class="bg-transparent border-0" data-dismiss="modal" aria-label="Close">
                                    <div
                                        ...
                                        <img :src="`/storage/${like.profile.profile_img}`"
                                             alt="img"
                        ...
                        <div v-if="AuthUser.id!==like.id" class="mb-3 mr-5">
                            <follow :isfollowing="authFollowings.find(authFollowing => authFollowing.user_id === like.id)" :profile-id="like.id"></follow>
                        </div>
...
<script>
    ...
    export default {
        name: "LikelistModal",
        components: {Follow},
        props: ['DataTarget', 'AuthUser', 'likes'],
        data(){
            return{
            }
        },
