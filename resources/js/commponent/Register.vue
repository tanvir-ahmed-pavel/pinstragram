                        ...
                        <div class="card-body crd-body">
                            <form @submit.prevent="registerReq">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-md-2 col-form-label text-md-right text reg-label">
                                    ...
                                    <div class="col-md-9">
                                        <input id="name" type="text" v-model="form.name" class="form-control reg-input-field"
                                ...
                                <div class="form-group row">
                                    <label for="email" class="col-md-2 col-form-label text-md-right reg-label">
                                    ...
                                    <div class="col-md-9">
                                        <input id="email" type="email" v-model="form.email" class="form-control reg-input-field"
                                ...
                                <div class="form-group row">
                                    <label for="password" class="col-md-2 col-form-label text-md-right reg-label">
                                    ...
                                    <div class="col-md-9">
                                        <input id="password" v-model="form.password" type="password" class="form-control reg-input-field"
                                ...
                                <div class="form-group row">
                                    <label for="password-confirm" class="col-md-2 col-form-label text-md-right reg-label">
                                    ...
                                    <div class="col-md-9">
                                        <input id="password-confirm" v-model="form.password_confirmation" type="password"
                                               class="form-control reg-input-field" name="password_confirmation"
                                               placeholder="Confirm Password" autocomplete="new-password">
                                        <div class="mt-3 text-muted">
                                            Already have an account??
                                            <router-link to="/login" class="text-decoration-none m-1">
                                                <strong>Login</strong>
                                            </router-link>
                                        </div>
                                    </div>
